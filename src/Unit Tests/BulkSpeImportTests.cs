...
namespace BibtexManagerUnitTests
{
	...
	public class BulkSpeImportTests
	{
		...
		public void SearchTest1()
		{
			...
			string path = @"..\..\..\..\Test Files\Test File 1.bibproj";
			...
			foreach (ImportResult result in project.BulkImport(importer))
			{
				string bibEntryString = result.BibEntry.ToString();
			}
		}
		...
		public void ConferenceImportTest()
		{
			...
			SpeConferenceImporter importer = new SpeConferenceImporter(new string[] { search1 });
